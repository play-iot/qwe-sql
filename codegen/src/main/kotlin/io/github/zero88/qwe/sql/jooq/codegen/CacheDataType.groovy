package io.github.zero88.qwe.sql.jooq.codegen
//class CacheDataType {
//
...
//            renameFields.put(StringUtils.toRegexIgnoreCase(it.key), it.value)
//        }
//        return this
//    }
//
//    def addDataType(String customClass, String convertCommand, String parseCommand, String defaultValue = "null") {
//        String className = StringUtils.requireNotBlank(customClass, "Class cannot be blank")
//        converters.put(className, toFunc(convertCommand))
//        parsers.put(className, toFunc(parseCommand))
//        defaultValues.put(className, StringUtils.isBlank(defaultValue) ? "null" : defaultValue)
//    }
//
